...
import {
  ...
  UploadContainer,
  UploadInfo,
} from "./CoWorkingSpaceRegistration.styles";
import { provinces } from "../../utils/address";
import { useDispatch, useSelector } from "react-redux";
import {
  createCoWorkingSpaceAction,
  resetCoWorkingSpaceDispatchCounter,
} from "../../features/co-working-space/coWorkingSpaceSlice";
import { updateUserToRegistered } from "../../features/auth/authSlice";

const CoWorkingSpaceRegistrationPage = () => {
  ...
  const onFinish = (values) => {
    ...
    dispatch(createCoWorkingSpaceAction(values));
  };
  ...
  useEffect(() => {
    if (dispatchCounter === 0) {
      ...
      dispatch(resetCoWorkingSpaceDispatchCounter());
  ...
  return (
    <MainContainer>
      ...
      <Container>
        <Title>
          Co-working Space <TitleSpan>Registration</TitleSpan>
        </Title>
        <Subtitle>
          Complete the Co-working Space Registration form to officially join our
          Co-working Space community and unlock exclusive benefits and
          opportunities.
        </Subtitle>
        <Form layout="vertical" onFinish={onFinish}>
          <FormContainer>
            <CategoryTitle>Co-working Space Information</CategoryTitle>
            <Form.Item
              label="Name of Co-working Space"
              name="name"
              rules={[
                {
                  required: true,
                  message: "Please input co-working space name.",
                },
              ]}
            >
              <Input placeholder="Input co-working space name" required />
            </Form.Item>
            <Form.Item
              label="Vision"
              name="description"
              rules={[
                {
                  required: true,
                  message: "Please input Co-working space's description.",
                },
              ]}
            >
              <Input placeholder="Input description" required />
            </Form.Item>
            <Line />
...
export default CoWorkingSpaceRegistrationPage;
