...
const IHubRegistrationPage = () => {
  ...
  const onFinish = (values) => {
    ...
    dispatch(createIHubAction(values));
  };
  ...
  return (
    <MainContainer>
      ...
      <Container>
        <Title>
          i-Hub <TitleSpan>Registration</TitleSpan>
        </Title>
        <Subtitle>
          Complete the i-Hub Registration form to officially join our i-Hub
          community and unlock exclusive benefits and opportunities.
        </Subtitle>
        <Form layout="vertical" onFinish={onFinish}>
          <FormContainer>
            <CategoryTitle>i-Hub Information</CategoryTitle>
            <Form.Item
              label="Name of i-Hub"
              name="name"
              rules={[
                {
                  required: true,
                  message: "Please input i-hub name.",
                },
              ]}
            >
              <Input placeholder="Input i-hub name" required />
            </Form.Item>
            <Form.Item
              label="Vision"
              name="description"
              rules={[
                {
                  required: true,
                  message: "Please input i-Hub's vision.",
                },
              ]}
            >
...
export default IHubRegistrationPage;
