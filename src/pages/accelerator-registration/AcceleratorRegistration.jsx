...
import {
  ...
  UploadContainer,
  UploadInfo,
} from "./AcceleratorRegistration.styles";
...
const AcceleratorRegistrationPage = () => {
  ...
  const onFinish = (values) => {
    ...
    dispatch(createAcceleratorAction(values));
  };
  ...
  return (
    <MainContainer>
      ...
      <Container>
        <Title>
          Accelerator <TitleSpan>Registration</TitleSpan>
        </Title>
        <Subtitle>
          Complete the Accelerator Registration form to officially join our
          Accelerator community and unlock exclusive benefits and opportunities.
        </Subtitle>
        <Form layout="vertical" onFinish={onFinish}>
          <FormContainer>
            <CategoryTitle>Accelerator Information</CategoryTitle>
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: "Please input accelerator name.",
                },
              ]}
            >
              <Input placeholder="Input accelerator name" required />
            </Form.Item>
            <Form.Item
              label="Vision"
              name="description"
              rules={[
                {
                  required: true,
                  message: "Please input Accelerator's vision.",
                },
              ]}
            >
...
export default AcceleratorRegistrationPage;
