...
import {
  ...
  UploadContainer,
  UploadInfo,
} from "./FoodInnovationRegistration.styles";
...
const FoodInnovationRegistrationPage = () => {
  ...
  return (
    <MainContainer>
      ...
      <Container>
        <Title>
          Food Innovation Center <TitleSpan>Registration</TitleSpan>
        </Title>
        <Subtitle>
          Complete the Food Innovation Center Registration form to officially
          join our Food Innovation Center community and unlock exclusive
          benefits and opportunities.
        </Subtitle>
        <Form layout="vertical" onFinish={onFinish}>
          <FormContainer>
            <CategoryTitle>Food Innovation Center Information</CategoryTitle>
            <Form.Item
            ...
            >
              <Input placeholder="Input food innovation center name" required />
            </Form.Item>
            <Form.Item
              label="Vision"
              name="description"
              rules={[
                {
                  required: true,
                  message: "Please input Food Innovation Center's vision.",
                },
              ]}
            >
...
export default FoodInnovationRegistrationPage;
