...
const TBIRegistrationPage = () => {
  ...
  const onFinish = (values) => {
    ...
    dispatch(createTBIAction(values));
  };
  ...
  return (
    <MainContainer>
      ...
      <Container>
        <Title>
          TBI <TitleSpan>Registration</TitleSpan>
        </Title>
        <Subtitle>
          Complete the TBI Registration form to officially join our TBI
          community and unlock exclusive benefits and opportunities.
        </Subtitle>
        <Form layout="vertical" onFinish={onFinish}>
          <FormContainer>
            <CategoryTitle>TBI Information</CategoryTitle>
            <Form.Item
            ...
            >
              <Input placeholder="Input TBI name" required />
            </Form.Item>
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message: "Please input university affiliated name.",
                },
              ]}
            >
              <Input placeholder="Input university affiliated name" required />
            </Form.Item>
            <Form.Item
              label="Vision"
              name="description"
...
export default TBIRegistrationPage;
