...
const Profile = () => {
  ...
  const col = collection(db, "accelerator");
  ...
  const onFinish = async (values) => {
    ...
    try {
      ...
      openNotification({
        isSuccess: true,
        message: "Successfully updated accelerator information.",
      });
    } catch (err) {
      setLoading(false);
      return openNotification({
    ...
    <Container>
      ...
      <StyledForm form={form} layout="vertical" onFinish={onFinish}>
        <LeftContainer>
          ...
          <ProfileContainer>
            ...
            <LeftFormContainer>
              ...
              >
                <StyledInput placeholder="Name of Accelerator" />
              </StyledFormItem>
              <StyledFormItem
                label="Vision"
                name="description"
        ...
        <RightContainer>
          ...
          <RightStatusContainer>
            <Heading>Accelerator Status</Heading>
