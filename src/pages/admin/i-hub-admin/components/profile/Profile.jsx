  ...
  return (
    <Container>
      ...
      <StyledForm form={form} layout="vertical" onFinish={onFinish}>
        <LeftContainer>
          <Heading>Innovation Hub</Heading>
          <ProfileContainer>
            <LeftProfileContainer>
              <div>
                <UpdateFormTitle>
            ...
            <LeftFormContainer>
              <Subtitle>Innovation Hub Information</Subtitle>
              <StyledFormItem
                label="Name of Innovation Hub"
                name="name"
                rules={[
                  {
                    message: "Please input innovation hub name.",
                    required: true,
                  },
                ]}
              >
                <StyledInput placeholder="Name of Innovation Hub" />
              </StyledFormItem>
              <StyledFormItem
                label="Vision"
                name="description"
        ...
        <RightContainer>
          ...
          <RightStatusContainer>
            <Heading>Innovation Hub Status</Heading>
