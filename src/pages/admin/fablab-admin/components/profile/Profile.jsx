      ...
      <StyledForm form={form} layout="vertical" onFinish={onFinish}>
        <LeftContainer>
          ...
          <ProfileContainer>
            ...
            <LeftFormContainer>
              <Subtitle>Fab-lab Information</Subtitle>
              <StyledFormItem
              ...
              >
                <StyledInput placeholder="Name of Fab-Lab" />
              </StyledFormItem>
              <StyledFormItem
                label="Vision"
                name="description"
        ...
        <RightContainer>
          ...
          <RightStatusContainer>
            <Heading>Fab-Lab Status</Heading>
