...
const Profile = () => {
  ...
  const col = collection(db, "coWorkingSpace");
  ...
  const onFinish = async (values) => {
    ...
    try {
      ...
      await setDoc(
        doc(db, "coWorkingSpace", auth.uid),
        {
          ...values,
        },
        { merge: true }
  ...
  return (
    <Container>
      ...
      <StyledForm form={form} layout="vertical" onFinish={onFinish}>
        <LeftContainer>
          <Heading>Co-working Space</Heading>
          <ProfileContainer>
            <LeftProfileContainer>
              <div>
                <UpdateFormTitle>
            ...
            <LeftFormContainer>
              <Subtitle>Co-working Space Information</Subtitle>
              <StyledFormItem
              ...
              >
                <StyledInput placeholder="Name of Co-working Space" />
              </StyledFormItem>
              <StyledFormItem
                label="Vision"
                name="description"
        ...
        <RightContainer>
          ...
          <RightStatusContainer>
            <Heading>Co-working Space Status</Heading>
